...
```bash
droid mcp add god-prompt "npx -y god-prompt-mcp@1.0.31"
```
...
```bash
goose session --with-extension "npx -y god-prompt-mcp@1.0.31"
```
...
```bash
openclaw mcp add god-prompt --command npx --arg -y --arg god-prompt-mcp@1.0.31
